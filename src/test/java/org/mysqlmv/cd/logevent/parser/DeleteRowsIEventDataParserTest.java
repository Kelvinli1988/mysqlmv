 ...
 */
public class DeleteRowsIEventDataParserTest {
    Event event;
    ...
    public void parse() throws IOException {
        ...
        DeleteRowsIEventData data = parser.parse(new ByteArrayInputStream(new java.io.ByteArrayInputStream(eData.getData())));
